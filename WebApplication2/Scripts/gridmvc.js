...
GridMvc = (function ($) {
    ...
    gridMvc.prototype.init = function () {
        ...
        //if (typeof (this.lang) == 'persian')
            this.lang = GridMvc.lang.pe;
        this.events = [];
...
GridMvc.lang.pe = {
    ...
    filterValueLabel: "مقایسه با :",
    applyFilterButtonText: "فیلتر",
    filterSelectTypes: {
        Equals: "مساوی ",
        StartsWith: "شروع با",
        Contains: "شامل",
    ...
    textFilterWidget.prototype.renderWidget = function () {
        var html = '<div Class="col-lg-12">\
                        <div class="form-group">\
                            <label style="float:right">' + this.lang.filterTypeLabel + '</label>\
                            <select class="grid-filter-type form-control" style="height:40px">\
                        ...
                        <div class="form-group">\
                            <label style="float:right">' + this.lang.filterValueLabel + '</label>\
